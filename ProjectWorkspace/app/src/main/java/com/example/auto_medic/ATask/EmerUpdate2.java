...
public class EmerUpdate2 extends AsyncTask<Void, Void, Void> {
    String Name;
    int  alarm, alarmperiod, message, tel;

    public EmerUpdate2(String name, int alarm, int alarmperiod, int message, int tel) {
        Name = name;
        this.alarm = alarm;
    ...
    protected Void doInBackground(Void... voids) {
        try {
            ...
            String postURL = ipConfig + "/app/emerUpdateMultiNo2";
