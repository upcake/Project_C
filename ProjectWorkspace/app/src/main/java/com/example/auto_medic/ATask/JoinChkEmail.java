...
public class JoinChkEmail extends AsyncTask<Void, Void, Void> {

    String member_email;

    //생성자 만들기
    public JoinChkEmail(String member_email) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try {
            ...
            String postURL = ipConfig + "/app/anEmailChk";
            // 전송
            ...
            emailchkDTO = readMessage(inputStream);
    ...
    public MemberDTO readMessage(InputStream inputStream) throws IOException {
        ...
        String member_email = "", member_nickname = "", member_phonenum = "";
        ...
        reader.endObject();
        Log.d("main:joinChkEmail : ", member_email + "," + member_nickname + "," + member_phonenum);
        return new MemberDTO(member_email, member_nickname, member_phonenum);
